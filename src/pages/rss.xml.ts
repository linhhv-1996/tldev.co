...
export const GET: APIRoute = async ({ site }) => {
  try {
    ...
    return rss({
      title: `${SITE.title} - Curated TL;DRs for Builders`,
      ...
      customData: `
        ...
        <ttl>60</ttl>
        <managingEditor>${SITE.author} (${SITE.email || 'linhhv.work@gmail.com'})</managingEditor>
        <webMaster>${SITE.author} (${SITE.email || 'linhhv.work@gmail.com'})</webMaster>
        <image>
